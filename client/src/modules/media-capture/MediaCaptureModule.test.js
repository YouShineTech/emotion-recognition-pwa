...
const MediaCaptureModule_1 = require("./MediaCaptureModule");
...
describe('MediaCaptureModule', () => {
    ...
    beforeEach(() => {
        ...
        mediaCaptureModule = new MediaCaptureModule_1.MediaCaptureModule();
    });
    afterEach(() => {
    ...
    describe('startCapture', () => {
        ...
        it.skip('should handle device not found error', async () => {
            ...
            await expect(mediaCaptureModule.startCapture(config)).rejects.toThrow('No camera or microphone found');
        });
    });
    ...
    describe('switchCamera', () => {
        it('should switch to specified camera device', async () => {
            ...
            expect(mockGetUserMedia).toHaveBeenNthCalledWith(2, expect.objectContaining({
...
//# sourceMappingURL=MediaCaptureModule.test.js.map