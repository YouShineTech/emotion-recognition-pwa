...
class PWAShellModule {
    ...
    async registerServiceWorker() {
        ...
        try {
            this.serviceWorker = await navigator.serviceWorker.register(this.config.serviceWorkerPath || '/sw.js');
...
exports.PWAShellModule = PWAShellModule;
exports.default = PWAShellModule;
//# sourceMappingURL=PWAShellModule.js.map