...
export interface IAudioAnalysisModule {
    ...
    analyzeAudio(audioData: Buffer, sessionId: string, timestamp: number): Promise<AudioEmotionResult>;
    analyzeBatch(audioChunks: Array<{
        data: Buffer;
        sessionId: string;
        timestamp: number;
...
//# sourceMappingURL=audio-analysis.interface.d.ts.map